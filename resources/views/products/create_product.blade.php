                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <a href="http://localhost/products/categories" class=" btn btn-outline-primary btn-md m-1"><i class="i-Add me-2 font-weight-bold"></i>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <a href="http://localhost/products/brands" class=" btn btn-outline-primary btn-md m-1"><i class="i-Add me-2 font-weight-bold"></i>
                            {{ __('translate.Create') }}</a>
                        </div>
